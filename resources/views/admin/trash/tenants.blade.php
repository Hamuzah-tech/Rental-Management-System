...
@section('title', 'Archived Tenants - Admin')

@section('content')
<div class="max-w-7xl mx-auto">
    <div class="flex justify-between items-center mb-6">
        <div>
            <h1 class="text-2xl font-bold text-slate-800">Archived Tenants</h1>
            <p class="text-slate-500 text-sm">Manage all soft-deleted tenants</p>
        </div>
                        ...
                        <tr>
                            ...
                            <td class="px-6 py-4 text-center">
                                <div class="flex items-center justify-center gap-2">
                                    <!-- Restore -->
                                    <form action="{{ route('admin.trash.tenants.restore', $tenant->id) }}" 
                                    ...
                                    <!-- Force Delete -->
                                    <form action="{{ route('admin.trash.tenants.force-delete', $tenant->id) }}" 
                                          method="POST" class="inline"
