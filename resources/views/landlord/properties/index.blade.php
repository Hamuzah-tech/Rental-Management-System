...
<div id="confirmModal" 
    ...
    <!-- Modal Box -->
    <div id="modalBox" 
         class="relative bg-white rounded-xl border border-slate-200 w-full max-w-md p-6 transform transition-all duration-300"
        ...
        <p id="modalMessage" class="text-sm text-slate-500 mb-6">
        </p>

        <div class="flex flex-col-reverse sm:flex-row justify-end gap-3">
            <button
                onclick="closeConfirmModal()"
                class="px-4 py-2 rounded-xl border border-slate-200 text-slate-600 hover:bg-slate-50 w-full sm:w-auto transition-colors">
                Cancel
            </button>
            <button
                onclick="submitConfirmAction()"
                class="px-4 py-2 rounded-xl bg-slate-800 hover:bg-slate-900 text-white w-full sm:w-auto transition-colors">
                Confirm
            </button>
        </div>
    </div>
