...
<div class="min-h-screen bg-slate-100 py-12">
    ...
    <div class="max-w-3xl mx-auto">
        ...
        <div class="bg-white rounded-2xl shadow-sm border border-slate-200 overflow-hidden">
            ...
            <div class="bg-green-600 px-8 py-8 text-center">
            ...
            <div class="p-8">
                ...
                <div class="rounded-xl border border-blue-200 bg-blue-50 p-6 text-center">
                    ...
                    <h2 class="mt-3 text-4xl font-extrabold text-blue-700 tracking-widest">
                ...
                <div class="mt-8 flex flex-col md:flex-row gap-4">
                    ...
                    <a href="#"
                       class="flex-1 bg-blue-600 hover:bg-blue-700 text-white text-center py-3 rounded-xl font-semibold transition">
